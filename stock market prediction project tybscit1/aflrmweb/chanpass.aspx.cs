...
public partial class aflrmweb_profile : System.Web.UI.Page
{
    ...
    protected void det()                    //in this select the email from database to update and sent to button2_click fn
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["str"].ConnectionString);
        SqlCommand com;
        ...
        con.Open();
        str = "select email from Usrdata where username='" + Session["username1"] + "'";
